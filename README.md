...
一个专为 Unciv 设计的现代化管理工具。

该项目通篇使用AI生成，vibecoding产品，本人只在AI陷入困境时进行少量修改。
在此感谢lytvpk作者的分享，我从他的项目中学到了很多，这个umm也是参考了他很多的设计思想,以及unciv原版的很多功能也放上来了，在做这个项目的时候unciv的定位模组错误功能还没那么强，可是现在已经比较完备了，有点出乎我的意料，同时也参考了一些其他管理器的设计思想，比如PCL启动器
## 🚀 功能特性
...
### 存档浏览
- **存档管理**: 浏览 `SaveFiles/` 目录，查看存档详情、文明、回合，可以备份
- **模组列表**: 显示存档启用了哪些模组
- **删除存档**: 支持删除无用存档
